...
export default function WinnerBlock({ data }: { data: ResultsData }) {
  return (
    <div className="w-full bg-gradient-to-bl from-lime-500/70 via-orange-500/60 to-orange-400/50 backdrop-blur-md border-4 border-lime-400/70 rounded-3xl shadow-2xl flex md:flex-row items-center justify-between px-4 md:px-6 py-5 relative z-20">
